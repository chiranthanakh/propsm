...
public class Individuallistitems {
    ...
    public Individuallistitems(String contractor_id, String location_id, String sub_location_id, String date, String user_id, String remarks) {
